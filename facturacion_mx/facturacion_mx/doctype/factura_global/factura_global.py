...
#Metodo para solicitar la creacion de una factura global
	def create_cfdi_global(self):
		...
		recibos_list = get_receipts_factura_global(fecha_inicial,fecha_final)
		ereceipts_id = get_ereceipts_id_factura_global(recibos_list) #fix: de alguna manera tendre que seleccionar name, que no sea con el indice 0
		forma_de_pago = get_forma_de_pago_global(recibos_list)
